  ...
  return (
    <View style={{flex: 1}} className=" bg-white">
      ...
      <View className="flex-row items-center  p-5">
        ...
        <Text className="text-lg font-['Poppins-SemiBold'] capitalize ml-4">
          Profile Screen
        </Text>
      </View>
      ...
      <View className="w-full p-4 justify-center items-center">
        ...
        <Text className="mt-4 font-bold font-['Poppins-SemiBold']">{name}</Text>
        <Text className="mt-1 font-bold font-['Poppins-SemiBold']">
          {email}
        </Text>
        ...
        <View className="justify-between flex flex-row">
          <View className="flex flex-row">
            <View className="w-8 h-8 rounded-full bg-[#CCE3FF] justify-center items-center">
              <IconIonicons name="document-text-outline" size={20} />
            </View>
          ...
          <View>
            <View className="w-8 h-8 rounded-full bg-[#CCE3FF] justify-center items-center">
              <IconMaterialIcons name="arrow-forward-ios" size={20} />
            </View>
          </View>
        </View>
      </View>
      ...
      <TouchableOpacity onPress={logout}>
        <View className="w-ful px-4 mt-4">
          <View className="justify-between flex flex-row">
            <View className="flex flex-row">
              <View className="w-8 h-8 rounded-full bg-[#CCE3FF] justify-center items-center">
                <IconMaterialIcons name="logout" size={20} />
              </View>
              <View className="justify-center ml-2">
                <Text className="font-['Poppins-SemiBold']">Logout</Text>
              </View>
            </View>
            <View>
              <View className="w-8 h-8 rounded-full bg-[#CCE3FF] justify-center items-center">
